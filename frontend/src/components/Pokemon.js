    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.status === 200) {
          axios
            .get(
              `https://pokeapi.co/api/v2/pokemon/${res.data.name.english.toLowerCase()}`
            )
            .then((img) => {
      ...
      <div className="pokemonOne">
        <div className="pokeDetail">
          <div>
            <p>
              <h3>
                <b>{pokemon?.name?.english}</b>
              </h3>
            </p>
            <p>
              <b>Pokemon type:</b> {pokemon?.type}
            </p>
            <p>
              <b>Pokemon HP:</b> {pokemon?.base?.HP}
            </p>
            ...
            <p>
              <b>Pokemon Attack:</b> {pokemon?.base?.Attack}
            </p>
            <div className="progress">
              <div
                className="progress-bar progress-bar-striped progress-bar-animated"
            ...
            <p>
              <b>Pokemon Defense:</b> {pokemon?.base?.Defense}
            </p>
            <div className="progress">
              <div
                className="progress-bar progress-bar-striped progress-bar-animated"
            ...
            <p>
              <b>Pokemon Speed:</b> {pokemon?.base?.Speed}
            </p>
            <div className="progress">
              <div
                className="progress-bar progress-bar-striped progress-bar-animated"
          ...
          <div className="pokeDescription">
            ...
            <p>
              ...
              amet, voluptatibus aperiam beatae reiciendis distinctio ullam.
              Sapiente sunt, esse, repudiandae consectetur fugiat eligendi
              blanditiis recusandae nesciunt aliquam nisi sit repellendus.
            </p>
          </div>
        </div>
      </div>
